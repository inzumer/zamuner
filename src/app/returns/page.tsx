...
import { Card, Icon, Navigate, RichText } from '@components';
        ...
        <>
            <section id='returns' className={styles.returns}>
                <div className={styles.returns__container}>
                    <RichText id='returns-title' className={styles.returns__title} variant='h1' text={t('returns.title')} />
                ...
                <div className={styles.returns__container}>
                    <RichText id='returns-comunity-title' className={styles.returns__title} variant='h1' text={t('returns.comunity-title')} />
                    <RichText id='returns-comunity-description' className={styles.returns__subtitle} variant='s3' text={t('returns.comunity-description')} />
                    <RichText id='returns-comunity-link' className={styles.returns__subtitle} variant='s3' text={t('returns.comunity-link')} />
                    <Navigate id='returns-comunity-button' className={styles.returns__button} href='https://www.facebook.com/groups/138597262891448/' >
